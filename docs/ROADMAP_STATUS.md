...
- Protocol support in git includes XML path overrides, fixed split handling, feature ablation configs, checkpoint evaluation metrics, XML candidate reporting in readiness checks, and default preflight guards in the long-run baseline/ablation wrappers.
